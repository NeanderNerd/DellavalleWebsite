...
<html lang="en">
	...
	<body>
		...
		<section class="container-fluid">
			...
			<p>
				We employ Certified Professional Agronomists/Soil Scientists and Crop Advisors with expertise
			...
			<p>
				Based in California's San Joaquin Valley, we serve clients throughout California, 11 Western
			...
			<p>
				An approved laboratory for the California Department of Food and Agriculture and the
