                ...
                <div class="accordion" id="aboutUsAccordion">
                    <div class="card">
                        <div class="card-header" id="consultantsHeading">
                            <h1 class="mb-0" style="margin-block-start: 0px">
                                <button id="accordionLinks" class="btn btn-link" type="button" data-toggle="collapse"
                                    data-target="#consultantsBody" aria-expanded="true" aria-controls="consultantsBody">
                                    Consultants
                                </button>
                            </h1>
                        </div>
                        <div id="consultantsBody" class="collapse" aria-labelledby="consultantsHeading"
                            data-parent="#aboutUsAccordion">
                            <div class="card-body">
                                <p>
                                ...
                                <table class="table-hover">
                                    <tbody>
                                        <tr>
                                            <th scope="row">
                                                <img alt="Nat B. Dellavalle" title="Nat B. Dellavalle"
                                                    class="img-thumbnail" src="images/consultants/nat.jpg">
                                            </th>
                                            <td>
                    ...
                    <div class="card">
                        <div class="card-header" id="clientServicesHeading">
                            <h1 class="mb-0" style="margin-block-start: 0px">
                                <button id="accordionLinks" class="btn btn-link" type="button" data-toggle="collapse"
                                    data-target="#clientServicesBody" aria-expanded="true"
                                    aria-controls="clientServicesBody">
                                    Client Services
                                </button>
                            </h1>
                        </div>
                        <div id="clientServicesBody" class="collapse" aria-labelledby="clientServicesHeading"
                            data-parent="#aboutUsAccordion">
                            <div class="card-body">
                                <p>
                    ...
                    <div class="card">
                        <div class="card-header" id="certSampHeading">
                            <h1 class="mb-0" style="margin-block-start: 0px">
                                <button id="accordionLinks" class="btn btn-link" type="button" data-toggle="collapse"
                                    data-target="#certSampBody" aria-expanded="true" aria-controls="certSampBody">
                                    Certified Samplers
                                </button>
                            </h1>
                        </div>
                        <div id="certSampBody" class="collapse" aria-labelledby="certSampHeading"
                            data-parent="#aboutUsAccordion">
                            <div class="card-body">
                                <p>
