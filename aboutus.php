...
<html lang="en">
	...
	<body>
		...
		<section class="container-fluid">
			<h1 style="font-family: 'Mr Dafoe',cursive;">About Us&nbsp;&nbsp;&nbsp;</h1>
			<p>
			...
			<div class="accordion" id ="aboutUsAccordion">
				<div class="card">
					...
					<div id="consultantsBody" class="collapse" aria-labelledby="consultantsHeading" data-parent="#aboutUsAccordion">
						<div class="card-body">
							<p>
								&emsp;In the field, there is no substitute for experience. Fortunately, experience is
							...
							<table class="table-hover">
								<tbody>
									...
									<tr>
										<th scope="row">
											<img alt="Keith M. Backman" title="Keith M. Backman" class="img-thumbnail" src="images/consultants/keith.jpg">
										</th>
										<td>
											<strong>Keith M. Backman</strong> - 44 Years Experience
											<br>
											<em>
									...
									<tr>
										<th scope="row">
											<img alt="Ben Nydam" title="Ben Nydam" class="img-thumbnail" src="images/consultants/ben.jpg">
										</th>
										<td>
											<strong>Ben Nydam</strong> - 25 Years Experience
											<br>
											<em>
									...
									<tr>
										<th scope="row">
											<img alt="Danyal Kasapligil" title="Danyal Kasapligil" class="img-thumbnail" src="images/consultants/danyal.jpg">
										</th>
										<td>
											<strong>Danyal Kasapligil</strong> - 26 Years Experience
											<br>
											<em>
											...
											<br>
											Mobile: (831) 750-4509<br>Area: Napa, Sacramento, Salinas, Special Projects
											<br>
									...
									<tr>
										<th scope="row">
											<img alt="Bill Blanken " title="Bill Blanken" class="img-thumbnail" src="images/consultants/bill.jpg">
										</th>
										<td>
											<strong>Bill Blanken</strong> - 58 Years Experience
											<br>
											<em>Agronomist</em>
											<br>
									...
									<tr>
										<th scope="row">
											<img alt="Anne Collins Burkholder" title="Anne Collins Burkholder" class="img-thumbnail" src="images/consultants/anne-sm.jpg">
										</th>
										<td>
											<strong>Anne Collins Burkholder</strong> - 8 Years Experience
											<br>
									...
									<tr>
										<th scope="row">
											<img alt="Lacey Mount" title="Lacey Mount" class="img-thumbnail" src="images/consultants/Lacey_Mount.jpg">
										</th>
										<td>
											<strong>Lacey Mount</strong> - 5 Years Experience
											<br>
									...
									<tr>
										<th scope="row">
											<img alt="Cynthia Tiemersma" title="Cynthia Tiemersma" class="img-thumbnail" src="images/consultants/cynthia.jpg">
										</th>
										<td>
											<strong>Cynthia Tiemersma</strong> - 3 Year Experience
											<br>
									...
									<tr>
										<th scope="row">
											<img alt="Sam Daud" title="Sam Daud" class="img-thumbnail" src="images/consultants/sam-daud.jpg">
										</th>
										<td>
											<strong>Sam Daud</strong> - 1 Year Experience
											<br>
											<em>Agronomist</em>
											<br>
				...
				<div class="card">
					...
					<div id="certSampBody" class="collapse" aria-labelledby="certSampHeading" data-parent="#aboutUsAccordion">
						<div class="card-body">
							...
							<p><a href="contactus.php">Call us</a> for more information.</p>
						</div>
					</div>
				</div>
			</div>
