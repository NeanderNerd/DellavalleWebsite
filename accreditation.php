	...
	<body>
	    ...
	    <section>
    	    <div class="container-fluid">
        	    <h1>Accreditation</h1>
            	<p>
                	&emsp;To insure quality results, Dellavalle utilizes internal quality control checks with replicate samples,
    	        ...
    	        <p>
        	        &emsp;Soil, plant tissue, agricultural water and manure (MAP): North American Proficiency Testing Program (NAPT)
