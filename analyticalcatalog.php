                ...
                <ul>
                    ...
                    <li>
                        <a href="downloads/analytical_catalog/Organic_Soil_Amendment.pdf" target="_blank"
                            title="Organic Soil Amendment (Manure, Compost)">
                            Organic Soil Amendment (Manure,Compost)
                        </a>
                    </li>
                    <li>
                        <a href="downloads/analytical_catalog/SOIL-AMENDMENT-ANALYSIS.pdf" target="_blank"
                            title="Soil Amendment (Gypsum, Lime, Ash)">
                    ...
                    <li>
                        <a href="downloads/analytical_catalog/FORAGE-AND-FEED-ANALYSIS.pdf" target="_blank"
                            title="Forage and Feed">
                            Forage and Feed
                        </a>
                    </li>
                    <li>
                        <a href="downloads/analytical_catalog/WATER-ANALYSIS.pdf" target="_blank"
