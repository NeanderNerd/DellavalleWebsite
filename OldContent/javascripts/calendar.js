...
COLORS
**********/
var DATE_HIGHLIGHT_BACKGROUND		= '#808080';
var DATE_HIGHLIGHT_COLOR		= '#ffffff';
var DATE_HIGHLIGHT_BORDER_COLOR		= 'ffffff';
var DAY_OF_WEEK_COLOR			= '#ffffff'; 
var HIGHLIGHT_DAY_OF_WEEK		= '#ffffff';
var DATE_COLOR				= '#ffffff';
var MONTH_COLOR				= '#ffffff';
var YEAR_COLOR				= '#ffffff';
...
var TR_start = '<TR>';
var TR_end = '</TR>';
var highlight_start = '<TD WIDTH="30"><TABLE CELLSPACING=0 BORDER="' + DATE_HIGHLIGHT_BORDER_SIZE + '" BGCOLOR="'+ DATE_HIGHLIGHT_BACKGROUND +'" BORDERCOLOR="' + DATE_HIGHLIGHT_BORDER_COLOR + '"><TR><TD WIDTH=33><CENTER>';
var highlight_end   = '</CENTER></TD></TR></TABLE>';
var TD_start = '<TD WIDTH="33" BACKGROUND="' + CALENDAR_BACKGROUND +'"><CENTER>';
