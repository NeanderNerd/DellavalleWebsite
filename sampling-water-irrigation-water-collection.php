...
<ul>
        ...
        <li>For drip irrigation if you suspect high Mn or Fe concentrations: </li>
                <ul>
                        ...
                        <li>Indicate your concern on the Work Request form and a portion will be acidified upon receipt.</li>
                </ul>
        <li>If possible, run Well for a few hours to purge uncharacteristic surface waters from shallow aquifers.  </li>
</ul>
<h4>Procedure:</h4>
<ul>
        <li>Fill container leaving no air space.  Carbonates, bicarbonates and nitrate are affected by the presence of air.  </li>
