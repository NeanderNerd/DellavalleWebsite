...
<body>
    ...
    <section>
        <div class="container-fluid">
            <h1 class="text-md-left text-center">Services</h1>
            <div class="row">
                <div class="col-12">
                    <p>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="nav nav-pills mb-3 center-pills" id="servicesTabs" role="tabList">
                ...
                <div class="tab-content col-12" id="pills-tabContent">
                    <div class="tab-pane fade show active" id="pills-lab" role="tabPanel" aria-labelledby="pills-lab-tab">
                        <h1 class="text-md-left text-center">Laboratory</h1>
                        <ul>
                            <li>
                    ...
                    <div class="tab-pane fade" id="pills-cons" role="tabPanel" aria-labelledby="pills-cons-tab">
                        <h1 class="text-md-left text-center">Consulting</h1>
                        <ul>
                            <li>
                    ...
                    <div class="tab-pane fade" id="pills-exp" role="tabPanel" aria-labelledby="pills-exp-tab">
                        <h1 class="text-md-left text-center">Other Expertise</h1>
                        <ul>
                            <li>
                    ...
                    <div class="tab-pane fade" id="pills-env" role="tabPanel" aria-labelledby="pills-env-tab">
                        <h1 class="text-md-left text-center">Dairies and the Environment</h1>
                        <p>
